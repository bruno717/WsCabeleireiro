...
public class MyQuery {
	...
	public static final String SELECT_USUARIOS = "SELECT * FROM tb_usuarios AS u INNER JOIN tb_dados_usuarios AS d INNER JOIN tb_enderecos AS e ON u.id_usuario = d.id_usuario AND d.id_endereco = e.id_endereco WHERE u.id_tipo_usuario = ? ORDEM BY u.ds_nome";
	...
	public static final String SELECT_TIPOS_PRODUTOS = "SELECT * FROM tb_tipos_produtos ORDEM BY ds_tipo_produto";
	...
	public static final String SELECT_PRODUTOS = "SELECT * FROM tb_produtos ORDEM BY ds_produto";
}
